...
var client = new ApolloClient__default({
  uri:
    process.env.SAPPER_APP_GRAPQL ||
    'https://hatchessentials.com/wp-api/graphql',
  fetch: fetch$1,
...
const BecomeMember = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
  ...
  <div class="${"container mx-auto mt-5"}"><div class="${"become-a-member svelte-1vdhjgm"}"><div class="${"member-forms svelte-1vdhjgm"}"><img src="${"https://hatchessentials.com/wp-api/wp-content/uploads/2020/06/BECOME-A-MEMBER.png"}" alt="${"hatchessentials become a member"}" class="${"svelte-1vdhjgm"}"></div>
...
const Nav = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	return `${ ``}
<nav class="${"main-nav svelte-nasof2"}"><div class="${"container mx-auto"}"><div class="${"nav-mobile flex items-center justify-between svelte-nasof2"}"><div>${ `<a href="${"."}" class="${"svelte-nasof2"}"><img class="${"logo svelte-nasof2"}" src="${"/logo.svg"}" alt="${"Hatch Essentials"}"></a>`
	}</div>
      <div><svg class="${"fill-current svelte-nasof2"}" xmlns="${"http://www.w3.org/2000/svg"}" viewBox="${"0 0 20 20"}">${ `<path d="${"M0 3h20v2H0V3zm0 6h20v2H0V9zm0 6h20v2H0v-2z"}"></path>`}</svg></div></div>
    <div class="${"nav-pc flex items-center justify-between svelte-nasof2"}"><div class="${"flex items-center"}"><a href="${"."}" rel="${"prefetch"}" class="${"svelte-nasof2"}"><img class="${"logo svelte-nasof2"}" src="${"/logo.svg"}" alt="${"Hatch Eessentials"}"></a></div>
      <div><ul class="${"flex hatch-nav svelte-nasof2"}"><li class="${"svelte-nasof2"}"><a href="${"."}"${add_attribute("aria-current", segment === undefined ? "page" : undefined, 0)} class="${"svelte-nasof2"}">Home
              ${segment === undefined
	? `<svg class="${"fill-current nav-item nav-item-1 svelte-nasof2"}" xmlns="${"http://www.w3.org/2000/svg"}" width="${"68"}" height="${"40.195"}" viewBox="${"0 0 68 40.195"}"><path id="${"Path_1233"}" data-name="${"Path 1233"}" d="${"M67.969,156.383a2.241,2.241,0,0,0-.786-1.707,2.278,2.278,0,0,0-3.2.249l-5.374,6.254-13.543-3.74a1.459,1.459,0,0,0-1.691.815l-6.234,13.16-11.245-15.5a1.4,1.4,0,0,0-1.919-.191l-8.344,6.849L8.8,141.454a1.662,1.662,0,0,0-.937-1.035,1.711,1.711,0,0,0-2.261.852h0A69.535,69.535,0,0,0,.851,157.516c0,.689-.212,1.381-.285,2.09s-.155,1.4-.232,2.09-.114,1.422-.228,2.037a12.578,12.578,0,0,0,0,2.111,59.6,59.6,0,0,0,.46,8.479,41.087,41.087,0,0,0,1.3,6.063h0v.077H65.956a40.537,40.537,0,0,0,1.283-5.048,57.95,57.95,0,0,0,.815-8.516v-7.868a23.977,23.977,0,0,0-.086-2.648Z"}" transform="${"translate(-0.061 -140.268)"}"></path></svg>`
	: `<svg class="${"fill-current nav-item nav-item-1 svelte-nasof2"}" xmlns="${"http://www.w3.org/2000/svg"}" width="${"68"}" height="${"26.292"}" viewBox="${"0 0 68 13.195"}"><path id="${"Asset_9"}" data-name="${"Asset 9"}" d="${"M77.8,51.392C70.275,36.25,57.84,25.1,43.8,25.1S17.325,36.25,9.8,51.392Z"}" transform="${"translate(-9.8 -25.1)"}"></path></svg>`}</a></li>
          <li class="${"svelte-nasof2"}"><a${add_attribute("aria-current", segment === "essential-oils-101" ? "page" : undefined, 0)} rel="${"prefetch"}" href="${"essential-oils-101"}" class="${"svelte-nasof2"}">Essential Oils 101
              ${segment === "essential-oils-101"
	? `<svg class="${"fill-current nav-item nav-item-2 svelte-nasof2"}" xmlns="${"http://www.w3.org/2000/svg"}" width="${"68"}" height="${"40.195"}" viewBox="${"0 0 68 40.195"}"><path id="${"Path_1233"}" data-name="${"Path 1233"}" d="${"M67.969,156.383a2.241,2.241,0,0,0-.786-1.707,2.278,2.278,0,0,0-3.2.249l-5.374,6.254-13.543-3.74a1.459,1.459,0,0,0-1.691.815l-6.234,13.16-11.245-15.5a1.4,1.4,0,0,0-1.919-.191l-8.344,6.849L8.8,141.454a1.662,1.662,0,0,0-.937-1.035,1.711,1.711,0,0,0-2.261.852h0A69.535,69.535,0,0,0,.851,157.516c0,.689-.212,1.381-.285,2.09s-.155,1.4-.232,2.09-.114,1.422-.228,2.037a12.578,12.578,0,0,0,0,2.111,59.6,59.6,0,0,0,.46,8.479,41.087,41.087,0,0,0,1.3,6.063h0v.077H65.956a40.537,40.537,0,0,0,1.283-5.048,57.95,57.95,0,0,0,.815-8.516v-7.868a23.977,23.977,0,0,0-.086-2.648Z"}" transform="${"translate(-0.061 -140.268)"}"></path></svg>`
	: `<svg class="${"fill-current nav-item nav-item-2 svelte-nasof2"}" xmlns="${"http://www.w3.org/2000/svg"}" width="${"68"}" height="${"26.292"}" viewBox="${"0 0 68 13.195"}"><path id="${"Asset_9"}" data-name="${"Asset 9"}" d="${"M77.8,51.392C70.275,36.25,57.84,25.1,43.8,25.1S17.325,36.25,9.8,51.392Z"}" transform="${"translate(-9.8 -25.1)"}"></path></svg>`}</a></li>
          <li class="${"svelte-nasof2"}"><a${add_attribute("aria-current", segment === "pursue-your-dreams" ? "page" : undefined, 0)} rel="${"prefetch"}" href="${"pursue-your-dreams"}" class="${"svelte-nasof2"}">Pursue Your Dreams
              ${segment === "pursue-your-dreams"
	? `<svg class="${"fill-current nav-item nav-item-3 svelte-nasof2"}" xmlns="${"http://www.w3.org/2000/svg"}" width="${"68"}" height="${"40.195"}" viewBox="${"0 0 68 40.195"}"><path id="${"Path_1233"}" data-name="${"Path 1233"}" d="${"M67.969,156.383a2.241,2.241,0,0,0-.786-1.707,2.278,2.278,0,0,0-3.2.249l-5.374,6.254-13.543-3.74a1.459,1.459,0,0,0-1.691.815l-6.234,13.16-11.245-15.5a1.4,1.4,0,0,0-1.919-.191l-8.344,6.849L8.8,141.454a1.662,1.662,0,0,0-.937-1.035,1.711,1.711,0,0,0-2.261.852h0A69.535,69.535,0,0,0,.851,157.516c0,.689-.212,1.381-.285,2.09s-.155,1.4-.232,2.09-.114,1.422-.228,2.037a12.578,12.578,0,0,0,0,2.111,59.6,59.6,0,0,0,.46,8.479,41.087,41.087,0,0,0,1.3,6.063h0v.077H65.956a40.537,40.537,0,0,0,1.283-5.048,57.95,57.95,0,0,0,.815-8.516v-7.868a23.977,23.977,0,0,0-.086-2.648Z"}" transform="${"translate(-0.061 -140.268)"}"></path></svg>`
	: `<svg class="${"fill-current nav-item nav-item-3 svelte-nasof2"}" xmlns="${"http://www.w3.org/2000/svg"}" width="${"68"}" height="${"26.292"}" viewBox="${"0 0 68 13.195"}"><path id="${"Asset_9"}" data-name="${"Asset 9"}" d="${"M77.8,51.392C70.275,36.25,57.84,25.1,43.8,25.1S17.325,36.25,9.8,51.392Z"}" transform="${"translate(-9.8 -25.1)"}"></path></svg>`}</a></li>
          <li class="${"svelte-nasof2"}"><a${add_attribute("aria-current", segment === "about-hatch" ? "page" : undefined, 0)} rel="${"prefetch"}" href="${"about-hatch"}" class="${"svelte-nasof2"}">About Hatch
              ${segment === "about-hatch"
	? `<svg class="${"fill-current nav-item nav-item-4 svelte-nasof2"}" xmlns="${"http://www.w3.org/2000/svg"}" width="${"68"}" height="${"40.195"}" viewBox="${"0 0 68 40.195"}"><path id="${"Path_1233"}" data-name="${"Path 1233"}" d="${"M67.969,156.383a2.241,2.241,0,0,0-.786-1.707,2.278,2.278,0,0,0-3.2.249l-5.374,6.254-13.543-3.74a1.459,1.459,0,0,0-1.691.815l-6.234,13.16-11.245-15.5a1.4,1.4,0,0,0-1.919-.191l-8.344,6.849L8.8,141.454a1.662,1.662,0,0,0-.937-1.035,1.711,1.711,0,0,0-2.261.852h0A69.535,69.535,0,0,0,.851,157.516c0,.689-.212,1.381-.285,2.09s-.155,1.4-.232,2.09-.114,1.422-.228,2.037a12.578,12.578,0,0,0,0,2.111,59.6,59.6,0,0,0,.46,8.479,41.087,41.087,0,0,0,1.3,6.063h0v.077H65.956a40.537,40.537,0,0,0,1.283-5.048,57.95,57.95,0,0,0,.815-8.516v-7.868a23.977,23.977,0,0,0-.086-2.648Z"}" transform="${"translate(-0.061 -140.268)"}"></path></svg>`
	: `<svg class="${"fill-current nav-item nav-item-4 svelte-nasof2"}" xmlns="${"http://www.w3.org/2000/svg"}" width="${"68"}" height="${"26.292"}" viewBox="${"0 0 68 13.195"}"><path id="${"Asset_9"}" data-name="${"Asset 9"}" d="${"M77.8,51.392C70.275,36.25,57.84,25.1,43.8,25.1S17.325,36.25,9.8,51.392Z"}" transform="${"translate(-9.8 -25.1)"}"></path></svg>`}</a></li>
          <li class="${"svelte-nasof2"}"><a${add_attribute("aria-current", segment === "the-blog" ? "page" : undefined, 0)} rel="${"prefetch"}" href="${"the-blog"}" class="${"svelte-nasof2"}">The Blog
              ${segment === "the-blog"
	? `<svg class="${"fill-current nav-item nav-item-5 svelte-nasof2"}" xmlns="${"http://www.w3.org/2000/svg"}" width="${"68"}" height="${"40.195"}" viewBox="${"0 0 68 40.195"}"><path id="${"Path_1233"}" data-name="${"Path 1233"}" d="${"M67.969,156.383a2.241,2.241,0,0,0-.786-1.707,2.278,2.278,0,0,0-3.2.249l-5.374,6.254-13.543-3.74a1.459,1.459,0,0,0-1.691.815l-6.234,13.16-11.245-15.5a1.4,1.4,0,0,0-1.919-.191l-8.344,6.849L8.8,141.454a1.662,1.662,0,0,0-.937-1.035,1.711,1.711,0,0,0-2.261.852h0A69.535,69.535,0,0,0,.851,157.516c0,.689-.212,1.381-.285,2.09s-.155,1.4-.232,2.09-.114,1.422-.228,2.037a12.578,12.578,0,0,0,0,2.111,59.6,59.6,0,0,0,.46,8.479,41.087,41.087,0,0,0,1.3,6.063h0v.077H65.956a40.537,40.537,0,0,0,1.283-5.048,57.95,57.95,0,0,0,.815-8.516v-7.868a23.977,23.977,0,0,0-.086-2.648Z"}" transform="${"translate(-0.061 -140.268)"}"></path></svg>`
	: `<svg class="${"fill-current nav-item nav-item-5 svelte-nasof2"}" xmlns="${"http://www.w3.org/2000/svg"}" width="${"68"}" height="${"26.292"}" viewBox="${"0 0 68 13.195"}"><path id="${"Asset_9"}" data-name="${"Asset 9"}" d="${"M77.8,51.392C70.275,36.25,57.84,25.1,43.8,25.1S17.325,36.25,9.8,51.392Z"}" transform="${"translate(-9.8 -25.1)"}"></path></svg>`}</a></li>
          <li class="${"svelte-nasof2"}"><a${add_attribute("aria-current", segment === "begin-now" ? "page" : undefined, 0)} target="${"_blank"}" href="${"https://www.youngliving.com/vo/?fbclid=IwAR04XTDfCKsSlbBwdWnUz881IpMz220ypID2DHWJLjnkMCmzGFoopN4v0wo#/signup/new-start?sponsorid=14065507&enrollerid=14065507&isocountrycode=PH&culture=en-PH&type=member"}" class="${"svelte-nasof2"}">Begin Now
              ${segment === "begin-now"
	? `<svg class="${"fill-current nav-item nav-item-6 svelte-nasof2"}" xmlns="${"http://www.w3.org/2000/svg"}" width="${"68"}" height="${"40.195"}" viewBox="${"0 0 68 40.195"}"><path id="${"Path_1233"}" data-name="${"Path 1233"}" d="${"M67.969,156.383a2.241,2.241,0,0,0-.786-1.707,2.278,2.278,0,0,0-3.2.249l-5.374,6.254-13.543-3.74a1.459,1.459,0,0,0-1.691.815l-6.234,13.16-11.245-15.5a1.4,1.4,0,0,0-1.919-.191l-8.344,6.849L8.8,141.454a1.662,1.662,0,0,0-.937-1.035,1.711,1.711,0,0,0-2.261.852h0A69.535,69.535,0,0,0,.851,157.516c0,.689-.212,1.381-.285,2.09s-.155,1.4-.232,2.09-.114,1.422-.228,2.037a12.578,12.578,0,0,0,0,2.111,59.6,59.6,0,0,0,.46,8.479,41.087,41.087,0,0,0,1.3,6.063h0v.077H65.956a40.537,40.537,0,0,0,1.283-5.048,57.95,57.95,0,0,0,.815-8.516v-7.868a23.977,23.977,0,0,0-.086-2.648Z"}" transform="${"translate(-0.061 -140.268)"}"></path></svg>`
	: `<svg class="${"fill-current nav-item nav-item-6 svelte-nasof2"}" xmlns="${"http://www.w3.org/2000/svg"}" width="${"68"}" height="${"26.292"}" viewBox="${"0 0 68 13.195"}"><path id="${"Asset_9"}" data-name="${"Asset 9"}" d="${"M77.8,51.392C70.275,36.25,57.84,25.1,43.8,25.1S17.325,36.25,9.8,51.392Z"}" transform="${"translate(-9.8 -25.1)"}"></path></svg>`}</a></li></ul></div></div></div></nav>`;
});
...
const Subscribe = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	return `<div class="${"subscribe-wrapper"}"><div class="${"container mx-auto"}"><div class="${"subscribe"}"><div class="${"subscribe-image"}"><img src="${"https://hatchessentials.com/wp-api/wp-content/uploads/2020/06/subscribe_new.jpg"}" alt="${""}"></div>
...
<div class="${"container mx-auto footer-links-nav"}"><div class="${"footer-links text-center md:flex md:justify-between svelte-1uit0mx"}"><span><a href="${"/essential-oils-101/#faq_section"}">FAQ</a></span>
    <span>•</span>
...
<div class="${"container mx-auto"}"><div class="${"yl-logo svelte-1uit0mx"}"><img src="${"/img/yl_logo.png"}" alt="${"www.youngliving.com logo"}" class="${"svelte-1uit0mx"}"></div></div>
